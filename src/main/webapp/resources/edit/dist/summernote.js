  ...
  */
  ...
  var Toolbar = function (context) {
    ...
    this.initialize = function () {
      ...
      $note.on('summernote.keyup edit.mouseup edit.change', function () {
  ...
  var HelpDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = [
        '<p class="text-center">',
        '<a href="http://edit.org/" target="_blank">Summernote 0.8.6</a> · ',
        '<a href="https://github.com/edit/edit" target="_blank">Project</a> · ',
        '<a href="https://github.com/edit/edit/issues" target="_blank">Issues</a>',
        '</p>'
      ].join('');
