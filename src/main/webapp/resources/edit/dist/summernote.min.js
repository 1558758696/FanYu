...
!function (a) {
    ...
    var isSupportAmd = "function" == typeof define && define.amd, isFontInstalled = function (a) {
        var b = "Comic Sans MS" === a ? "Courier New" : "Comic Sans MS", c = $("<div>").css({
                ...
                top: "-9999px",
                fontSize: "200px"
            }).text("mmmmmmmmmwwwwwww").appendTo(document.body), d = c.css("fontFamily", b).width(),
    ...
    var isSupportTouch = "ontouchstart" in window || navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
        agent = {
            ...
            return this.memos = {}, this.modules = {}, this.layoutInfo = {}, this.options = b, this.initialize = function () {
                ...
                var b = list.head(arguments), c = list.tail(list.from(arguments)),
                ...
                var a = list.head(arguments), b = list.tail(list.from(arguments)), c = a.split("."), d = c.length > 1,
                    e = d && list.head(c), f = d ? list.last(c) : list.head(c), g = this.modules[e || "editor"];
                return !e && this[f] ? this[f].apply(this, b) : g && g[f] && g.shouldInitialize() ? g[f].apply(g, b) : void 0
            }, this.initialize()
        };
    $.fn.extend({
        summernote: function () {
            var a = $.type(list.head(arguments)), b = "string" === a, c = "object" === a,
    ...
    var key = function () {
        ...
        var a = function (a, b) {
            ...
            this.getPoints = function () {
                ...
                var a = this.splitText(), b = a.nodes(null, {fullyContains: !0}),
            ...
            this.isOnEditable = h(dom.isEditable), this.isOnList = h(dom.isList), this.isOnAnchor = h(dom.isAnchor), this.isOnCell = h(dom.isCell), this.isOnData = h(dom.isData), this.isLeftEdgeOf = function (a) {
                ...
                var b = $("<div></div>").html(a)[0], c = list.from(b.childNodes),
        ...
        return {
            create: function (a, b, d, e) {
                ...
                var d = dom.fromOffsetPath(a, b.s.path), e = b.s.offset, f = dom.fromOffsetPath(a, b.e.path),
                    g = b.e.offset;
                return new c(d, e, f, g)
            }, createFromParaBookmark: function (a, b) {
                var d = a.s.offset, e = a.e.offset, f = dom.fromOffsetPath(list.head(b), a.s.path),
        ...
        this.fromNode = function (b) {
            ...
            a = a.splitText();
            var c = b && b.nodeName || "SPAN", d = !(!b || !b.expandClosestSibling),
        ...
        this.insertOrderedList = function (a) {
            ...
            var b = this, c = range.create(a).wrapBodyInlineWithPara(), d = c.nodes(dom.isPara, {includeAncestor: !0}),
            ...
            var d = range.create(c).wrapBodyInlineWithPara(), e = d.nodes(dom.isPara, {includeAncestor: !0}),
                f = d.paraBookmark(e), g = list.clusterBy(e, func.peq2("parentNode"));
            ...
            var c = list.head(a), d = list.last(a), e = dom.isList(c.previousSibling) && c.previousSibling,
                f = dom.isList(d.nextSibling) && d.nextSibling, g = e || dom.insertAfter(dom.create(b || "UL"), d);
            ...
            return $.each(a, function (a, d) {
                var e = list.head(d), f = list.last(d), g = b ? dom.lastAncestor(e, dom.isList) : e.parentNode,
        ...
        function l(a) {
            switch (b) {
                case TableResultAction.where.Column:
                    if (a.isColSpan) return TableResultAction.resultAction.SubtractSpanCount;
                    break;
                case TableResultAction.where.Row:
                    if (!a.isVirtual && a.isRowSpan) return TableResultAction.resultAction.AddCell;
                    if (a.isRowSpan) return TableResultAction.resultAction.SubtractSpanCount
            }
        ...
        function m(a) {
            switch (b) {
                case TableResultAction.where.Column:
                    ...
                    if (a.isRowSpan && a.isVirtual) return TableResultAction.resultAction.Ignore;
                    break;
                case TableResultAction.where.Row:
                    if (a.isRowSpan) return TableResultAction.resultAction.SumSpanCount;
                    if (a.isColSpan && a.isVirtual) return TableResultAction.resultAction.Ignore
            }
    ...
    TableResultAction.where = {Row: 0, Column: 1}, TableResultAction.requestAction = {
        Add: 0,
        Delete: 1
    }, TableResultAction.resultAction = {Ignore: 0, SubtractSpanCount: 1, RemoveCell: 2, AddCell: 3, SumSpanCount: 4};
    var Table = function () {
        this.tab = function (a, b) {
            var c = dom.ancestor(a.commonAncestor(), dom.isCell), d = dom.ancestor(c, dom.isTable),
                e = dom.listDescendant(d, dom.isCell), f = list[b ? "prev" : "next"](e, c);
            ...
            var c = dom.ancestor(a.commonAncestor(), dom.isCell), d = $(c).closest("tr");
            $(d).siblings().push(d);
            for (var e = new TableResultAction(c, TableResultAction.where.Column, TableResultAction.requestAction.Add, $(d).closest("table")[0]), f = e.getActionList(), g = 0; g < f.length; g++) {
                ...
                switch (h.action) {
                    ...
                    case TableResultAction.resultAction.SumSpanCount:
                        ...
                        } else $(h.baseCell).before("<td" + i + ">" + dom.blank + "</td>")
                }
            }
            ...
            for (var b = dom.ancestor(a.commonAncestor(), dom.isCell), c = $(b).closest("tr"), d = c.children("td, th").index($(b)), e = c[0].rowIndex, f = new TableResultAction(b, TableResultAction.where.Row, TableResultAction.requestAction.Delete, $(c).closest("table")[0]), g = f.getActionList(), h = 0; h < g.length; h++) if (g[h]) {
                var i = g[h].baseCell, j = g[h].virtualTable, k = i.rowSpan && i.rowSpan > 1,
                ...
                switch (g[h].action) {
                    ...
                    case TableResultAction.resultAction.AddCell:
                        ...
                        if (!m) continue;
                        var n = c[0].cells[d];
                        k && (l > 2 ? (l--, m.insertBefore(n, m.cells[d]), m.cells[d].setAttribute("rowSpan", l), m.cells[d].innerHTML = "") : 2 === l && (m.insertBefore(n, m.cells[d]), m.cells[d].removeAttribute("rowSpan"), m.cells[d].innerHTML = ""));
                        continue;
                    case TableResultAction.resultAction.SubtractSpanCount:
                        k && (l > 2 ? (l--, i.setAttribute("rowSpan", l), j.rowIndex !== e && i.cellIndex === d && (i.innerHTML = "")) : 2 === l && (i.removeAttribute("rowSpan"), j.rowIndex !== e && i.cellIndex === d && (i.innerHTML = "")));
                        continue;
            ...
            for (var b = dom.ancestor(a.commonAncestor(), dom.isCell), c = $(b).closest("tr"), d = c.children("td, th").index($(b)), e = new TableResultAction(b, TableResultAction.where.Column, TableResultAction.requestAction.Delete, $(c).closest("table")[0]), f = e.getActionList(), g = 0; g < f.length; g++) if (f[g]) switch (f[g].action) {
                case TableResultAction.resultAction.Ignore:
                    continue;
                case TableResultAction.resultAction.SubtractSpanCount:
                    var h = f[g].baseCell, i = h.colSpan && h.colSpan > 1;
                    if (i) {
                        var j = h.colSpan ? parseInt(h.colSpan, 10) : 0;
                        j > 2 ? (j--, h.setAttribute("colSpan", j), h.cellIndex === d && (h.innerHTML = "")) : 2 === j && (h.removeAttribute("colSpan"), h.cellIndex === d && (h.innerHTML = ""))
                    }
                    continue;
                case TableResultAction.resultAction.RemoveCell:
        ...
        var b = this, c = a.layoutInfo.note, d = a.layoutInfo.editor, e = a.layoutInfo.editable, f = a.options,
            g = f.langInfo, h = e[0], i = null, j = new Style, k = new Table, l = new Typing, m = new Bullet,
            n = new History(e);
        ...
        this.fontSize = function (a) {
            ...
            var k = range.createFromNodeBefore(list.head(h)), l = k.getStartPoint(),
                m = range.createFromNodeAfter(list.last(h)), n = m.getEndPoint();
            ...
            var a = this.createRange().expand(dom.isAnchor), b = $(list.head(a.nodes(dom.isAnchor))),
                c = {range: a, text: a.toString(), url: b.length ? b.attr("href") : ""};
        ...
        this.events = {
            ...
            var b = this.$paste[0].firstChild, c = b && b.src;
        ...
        var b = $(document), c = a.layoutInfo.editor, d = a.layoutInfo.editable, e = a.options, f = e.langInfo, g = {},
    ...
    var Codeview = function (a) {
        ...
        this.initialize = function () {
            ...
            c.on("mousedown", function (a) {
                ...
                var c = d.offset().top - b.scrollTop(), f = function (a) {
        ...
        var b = this, c = a.layoutInfo.editor, d = a.layoutInfo.toolbar, e = a.layoutInfo.editable,
            f = a.layoutInfo.codable, g = $(window), h = $("html, body");
        this.resizeTo = function (a) {
            ...
            c.toggleClass("fullscreen"), this.isFullscreen() ? (e.data("orgHeight", e.css("height")), g.on("resize", this.onResize).trigger("resize"), h.css("overflow", "hidden")) : (g.off("resize", this.onResize), this.resizeTo({h: e.data("orgHeight")}), h.css("overflow", "visible")), a.invoke("toolbar.updateFullscreen", this.isFullscreen())
        ...
        var b = this, c = /^([A-Za-z][A-Za-z0-9+-.]*\:[\/\/]?|mailto:[A-Z0-9._%+-]+@)?(www\.)?(.+)$/i;
        this.events = {
            ...
            if (this.lastWordRange) {
                var b = this.lastWordRange.toString(), d = b.match(c);
                if (d && (d[1] || d[2])) {
                    var e = d[1] ? b : "http://" + b, f = $("<a />").html(b).attr("href", e)[0];
                    this.lastWordRange.insertNode(f),
                        this.lastWordRange = null, a.invoke("editor.focus")
                }
            }
        ...
        var b = this, c = $.summernote.ui, d = a.layoutInfo.toolbar, e = a.options, f = e.langInfo,
            g = func.invertObject(e.keyMap[agent.isMac ? "mac" : "pc"]), h = this.representShortcut = function (a) {
                var b = g[a];
        ...
        this.initialize = function () {
            ...
            var b, c = $(a.target.parentNode), d = c.next(), f = c.find(".note-dimension-picker-mousecatcher"),
                g = c.find(".note-dimension-picker-highlighted"), h = c.find(".note-dimension-picker-unhighlighted");
            if (void 0 === a.offsetX) {
        ...
        this.shouldInitialize = function () {
            ...
            e.toolbar = e.toolbar || [], e.toolbar.length ? a.invoke("buttons.build", d, e.toolbar) : d.hide(), e.toolbarContainer && d.appendTo(e.toolbarContainer), c.on("summernote.keyup edit.mouseup edit.change", function () {
        ...
        this.initialize = function () {
            ...
            return $.Deferred(function (e) {
                var f = b.$dialog.find(".note-link-text"), g = b.$dialog.find(".note-link-url"),
                    h = b.$dialog.find(".note-link-btn"), i = b.$dialog.find("input[type=checkbox]");
        ...
        this.initialize = function () {
            ...
            return $.Deferred(function (d) {
                var e = b.$dialog.find(".note-image-input"), f = b.$dialog.find(".note-image-url"),
        ...
        this.events = {
            ...
            this.$popover = c.popover({className: "note-table-popover"}).render().appendTo("body");
            var b = this.$popover.find(".popover-content");
            a.invoke("buttons.build", b, d.popover.table), agent.isFF && document.execCommand("enableInlineTableEditing", !1, !1)
        }, this.destroy = function () {
            this.$popover.remove()
        }, this.update = function (b) {
            if (a.isDisabled()) return !1;
        ...
        this.createShortCutList = function () {
            ...
            var a = e.dialogsInBody ? $(document.body) : d,
                b = ['<p class="text-center">', '<a href="http://edit.org/" target="_blank">Summernote 0.8.6</a> · ', '<a href="https://github.com/edit/edit" target="_blank">Project</a> · ', '<a href="https://github.com/edit/edit/issues" target="_blank">Issues</a>', "</p>"].join("");
            this.$dialog = c.dialog({
        ...
        var b = this, c = $.summernote.ui, d = a.options.hint || [], e = a.options.hintDirection || "bottom",
            f = $.isArray(d) ? d : [d];
        this.events = {
            "summernote.keyup": function (a, c) {
                c.isDefaultPrevented() || b.handleKeyup(c)
